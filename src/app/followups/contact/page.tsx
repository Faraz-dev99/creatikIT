            ...
            <div className="flex min-h-[calc(100vh-56px)] overflow-auto bg-gray-200 max-md:py-10">
                ...
                {isfollowupDialogOpen && Array.isArray(followupDialogData) && followupDialogData.length > 0 && (
                    <PopupMenu onClose={() => { setIsFollowupDialogOpen(false); setFollowupDialogData([]); }}>
                        <div className="flex flex-col border border-gray-300/30 overflow-y-auto bg-gray-100 text-gray-900 rounded-xl shadow-lg p-6 max-w-[800px] gap-6 m-2 w-full max-h-[80vh]">
                            <h2 className="text-2xl text-gray-800 font-extrabold">Contact <span className="text-blue-600">Followups</span></h2>
                ...
                <div className="p-4 max-md:p-3 w-full">
                    <div className="flex justify-between items-center">
                        <h2 className="flex gap-2 items-center font-light">
                            <span className="text-gray-900 text-2xl">Dashboard</span>/<span>Contact Followups</span>
                        </h2>
                    </div>
                            ...
                            <div className={`overflow-hidden ${toggleSearchDropdown ? 'max-h-[2000px]' : 'max-h-0'} transition-all duration-500 ease-in-out px-5`}>
                                <div className="flex flex-col gap-5 my-5">
                                    <div className="grid grid-cols-3 gap-5 max-md:grid-cols-1 max-lg:grid-cols-2">
                                        ...
                                        <SingleSelect options={propertyTypes} value={filters.PropertyType[0]} label="Property Type" onChange={(val) => handleSelectChange("PropertyType", val)} />
                                        <SingleSelect options={statusTypes} value={filters.StatusType[0]} label="Status Type" onChange={(val) => handleSelectChange("StatusType", val)} />

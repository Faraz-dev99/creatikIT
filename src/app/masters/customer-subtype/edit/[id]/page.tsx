...
import { subtypeAllDataInterface } from "@/store/masters/subtype/subtypes.interface";
import { getSubtypeById, updateSubtype } from "@/store/masters/subtype/subtypes";
    ...
    <div className="bg-slate-200 min-h-screen p-6 flex justify-center">
      ...
      <div className="w-full">
        <div className="flex justify-end mb-4">
          <Link href="/masters/customer-subtype" className="flex items-center gap-2 bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700 transition-all">
        ...
        <div className="bg-white/90 backdrop-blur-lg p-10 w-full rounded-3xl shadow-2xl">
          <form onSubmit={(e) => e.preventDefault()} className="w-full">
            <div className="mb-8 text-left border-b pb-4 border-gray-200">
              <h1 className="text-3xl font-extrabold text-gray-800">Edit <span className="text-blue-600">Customer Subtype</span></h1>
            </div>
            ...
            <div className="flex flex-col space-y-6">
              ...
              <div className="flex justify-end mt-4">
                <button onClick={handleSubmit} className="bg-gradient-to-r from-blue-600 to-blue-800 text-white p-2 w-32 rounded-md font-semibold hover:scale-105 transition-all">Update</button>
              </div>
            </div>
          </form>
        </div>

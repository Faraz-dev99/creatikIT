      ...
      <div className="min-h-screen bg-slate-100 p-6">
        ...
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-2xl font-semibold text-gray-900 tracking-wide">
            Dashboard <span className="text-gray-500 text-sm">/ Location</span>
          </h1>
        </div>
        ...
        <div className="bg-white p-6 rounded-2xl shadow-lg border border-gray-200 relative">
          {/* Add Button */}
          <Link href="/masters/locations/add">
            ...
            <table className="table-auto w-full border-collapse text-sm">
              <thead className="bg-gray-900 text-white">
                <tr className="flex justify-between items-center w-full">
                  ...
                  <th className="flex items-center gap-10 px-8 py-3 text-left w-2/3">

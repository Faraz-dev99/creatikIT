        ...
        <div className="bg-white/90 backdrop-blur-lg p-10 rounded-3xl shadow-2xl">
          <div className="mb-8 border-b pb-4">
            <h1 className="text-3xl font-extrabold text-gray-800">
              Add <span className="text-blue-600">Builder Slider</span>
            </h1>
          </div>
          ...
          <form onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="flex justify-end mt-6">
              <button
                ...
                className="bg-gradient-to-r from-blue-600 to-blue-800 text-white font-semibold p-2 w-32 rounded-md hover:scale-105 transition-all"
              >
                Save
              </button>
            </div>

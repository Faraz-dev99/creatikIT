...
export default function login() {
    ...
    return <div className='flex flex-col relative justify-center items-center min-h-[calc(100vh-56px)]  bg-linear-to-r from-teal-500 to-blue-500'>
        ...
        <div className=" flex flex-col justify-center items-center relative z-10 w-full h-full">
            <div className=' flex flex-wrap  items-center justify-center w-full min-h-full gap-2 mt-20 mb-2'>
                {/* <img src='logo192.png' alt='logo' className=' w-[40px]'/> */}
                <h1 className=' text-xl font-bold text-white '>Sign In</h1>
            </div>

            <form className='flex flex-col justify-center  my-3 w-full max-w-96  gap-3 py-8 px-10 rounded-lg bg-white' onSubmit={addUser}>
    ...
    peer-[&:not(:placeholder-shown)]:-top-2 peer-[&:not(:placeholder-shown)]:text-xs peer-[&:not(:placeholder-shown)]:text-gray-600"
                ...
                <div className=' flex gap-2 text-[13px] mt-5'>Don't have an account? <Link href={'/signup'} className=' text-teal-600 font-bold'>Sign In</Link></div>
            </form>
